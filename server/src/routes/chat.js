...
2. Fill out the copy with the order details. The numbers come from the pick ticket report: open the fundraiser in the MoneyDolly portal (step 1 of the "Order cookie dough" task panel has an "Open MoneyDolly portal" button), then under Reports on the right click "Pick Ticket Report (PDF)". If the fundraiser has no MoneyDolly link yet, step 1 shows a box instead of the button: she opens the fundraiser in MoneyDolly, copies the address from the browser's address bar, and pastes it into that box — it saves on its own and the button appears.
